...
export default function LeftSidebar() {
    ...
    const sidebarItems = [
        { icons: <FaHome />, text: "Home" },
        { icons: <CiSearch />, text: "Search" },
        { icons: <FaRegCompass />, text: "Explore" },
        {
